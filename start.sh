...
cd /$ServerDir/glinkd; ./glinkd gamesys.conf 2 >> /$ServerDir/logs/glink2.log 2>&1 &
#cd /$ServerDir/glinkd; ./glinkd gamesys.conf 3 >> /$ServerDir/logs/glink3.log 2>&1 &
#cd /$ServerDir/glinkd; ./glinkd gamesys.conf 4 >> /$ServerDir/logs/glink4.log 2>&1 &
echo -e "=== [${txtgrn} OK ${txtnrm}] ==="
echo -e ""
sleep 0.5
